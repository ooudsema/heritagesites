...
class Planet(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'UNSD Global Location'
        verbose_name_plural = 'UNSD Global Location'
...
class Location(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Heritage Sites Location'
        verbose_name_plural = 'Heritage Sites Locations'

    def __str__(self):
        return '{} {} {}'.format(self.location_id, self.planet_id if self.planet_id else '', self.region_id if self.region_id else '')
